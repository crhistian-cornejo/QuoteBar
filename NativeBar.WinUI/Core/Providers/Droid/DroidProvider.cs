...
{
    private static NativeBar.WinUI.Views.DroidLoginWindow? _currentWindow;
    private static readonly object _lock = new();
    ...
    /// </summary>
    public static async Task<NativeBar.WinUI.Views.DroidLoginResult> LaunchLoginAsync()
    {
        lock (_lock)
        {
            if (_currentWindow != null)
            {
                ...
                return NativeBar.WinUI.Views.DroidLoginResult.Cancelled();
            }
        }
        ...
        try
        {
            ...
            var window = new NativeBar.WinUI.Views.DroidLoginWindow();
        ...
        catch (Exception ex)
        {
            ...
            return NativeBar.WinUI.Views.DroidLoginResult.Failed(ex.Message);
        }
        finally
        {
            lock (_lock)

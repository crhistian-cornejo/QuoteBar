...
{
    private static QuoteBar.Views.CopilotLoginWindow? _currentWindow;
    ...
    /// </summary>
    public static async Task<QuoteBar.Views.CopilotLoginResult> LaunchLoginAsync()
    {
        lock (_lock)
        {
            if (_currentWindow != null)
            {
                ...
                return QuoteBar.Views.CopilotLoginResult.Cancelled();
            }
        }
        ...
        try
        {
            ...
            var window = new QuoteBar.Views.CopilotLoginWindow();
